...
function initScrollAnimations() {
    ...
    const animatedElements = document.querySelectorAll('.about-card, .skill-item, .portfolio-item, .contact-item');
...
function initEasterEggs() {
    ...
    logo.addEventListener('click', function() {
        clickCount++;
        if (clickCount === 5) {
            showNotification('¡Easter egg encontrado! 🎨', 'success');
